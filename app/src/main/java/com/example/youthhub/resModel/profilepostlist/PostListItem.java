...
public class PostListItem implements Parcelable {
...
protected PostListItem(Parcel in){
	...
	public static final Parcelable.Creator<PostListItem> CREATOR = new Parcelable.Creator<PostListItem>() {
		@Override
		public PostListItem createFromParcel(Parcel source) {
			return new PostListItem(source);
		}
