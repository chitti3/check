...
public class Relatedexplore implements Parcelable
{
    ...
    @Expose
    private Object xcContentPoster;
    ...
    public final static Creator<Relatedexplore> CREATOR = new Creator<Relatedexplore>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Relatedexplore createFromParcel(Parcel in) {
            return new Relatedexplore(in);
        }

        public Relatedexplore[] newArray(int size) {
            return (new Relatedexplore[size]);
        }

    }
    ;

    protected Relatedexplore(Parcel in) {
        ...
        this.xcContentPoster = ((Object) in.readValue((Object.class.getClassLoader())));
    ...
    public Object getXcContentPoster() {
        return xcContentPoster;
    }

    public void setXcContentPoster(Object xcContentPoster) {
