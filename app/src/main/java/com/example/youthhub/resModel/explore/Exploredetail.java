...
public class Exploredetail implements Parcelable
{
    ...
    public final static Creator<Exploredetail> CREATOR = new Creator<Exploredetail>() {


        @SuppressWarnings({
            "unchecked"
        })
        public Exploredetail createFromParcel(Parcel in) {
            return new Exploredetail(in);
        }

        public Exploredetail[] newArray(int size) {
            return (new Exploredetail[size]);
        }

    }
    ;

    protected Exploredetail(Parcel in) {
