...
public class AwardsAdapter extends RecyclerView.Adapter<AwardsAdapter.MyViewHolder> implements AwardsDialog.OnUpdatePassDataListener,DeleteMessageDialog.OnDeleteListener{
    ...
    int deleteposition;
    private AwardPass awardPass;


    public void setAwardPass(AwardPass awardPass) {
        this.awardPass = awardPass;
    }

    public AwardsAdapter(Activity activity, ProfileInfoResp profileInfoResp, String userType) {
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, int i) {
        ...
        holder.awardsDelete.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DeleteMessageDialog deleteMessageDialog = new DeleteMessageDialog(activity,"Achievement and Awards",profileInfoResp.getData().getAchievement().get(i).getAcuAchievementId(),null,null);
                deleteMessageDialog.setOnDeleteListener(AwardsAdapter.this);
        ...
        holder.awardsCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                call_update_awards_master_api(profileInfoResp.getData().getAchievement().get(i).getAcuAchievementId(), AwardsAdapter.this, i);
                 //removeAt(i);
            }
        });
        ...
        if (userType.equalsIgnoreCase("1")) {
            holder.awardsDelete.setVisibility(View.VISIBLE);
            holder.awardsCard.setEnabled(true);
        } else {
            holder.awardsDelete.setVisibility(View.INVISIBLE);
            holder.awardsCard.setEnabled(false);
        }
    }
    ...
    public void OnDelete(boolean deleted) {
        if (deleted)
        {
          awardPass.PassAward(deleted,deleteposition,"Award");
    ...
    private void call_update_awards_master_api(String qualification_id, AwardsAdapter awardsAdapter, int position) {
    ...
    public interface AwardPass{
        void PassAward(boolean award,int id,String which);
    }
}
