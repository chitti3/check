 ...
 * Use the {@link EventPhotosFragment#newInstance} factory method to
...
public class EventPhotosFragment extends Fragment {
     ...
     * @return A new instance of fragment EventPhotosFragment.
     */
    // TODO: Rename and change types and number of parameters
    public static EventPhotosFragment newInstance(String param1, String param2) {
    ...
    public static EventPhotosFragment newInstance(EventViewData eventViewData) {
        EventPhotosFragment fragment = new EventPhotosFragment();
        Bundle args = new Bundle();
                    ...
                    if (response.isSuccessful()) {
                        ...
                        if (galleryResponse != null) {
                            if (galleryResponse.getStatus() == 1) {
                                ...
                                if (!galleryResponse.getMessage().isEmpty()) {
    ...
    private void call_adapter(GalleryResponse galleryResponse, final List<Gallery> galleries) {
        ...
        imagePath.put("path_large", galleryResponse.getGalleryData().getPathLarge());
        imagePath.put("path_medium", galleryResponse.getGalleryData().getPathMedium());
        imagePath.put("path_thumb", galleryResponse.getGalleryData().getPathThumb());

        GridLayoutManager gridLayoutManager = new GridLayoutManager(activity, 2);
        if (recyclerView != null) {
            recyclerView.setLayoutManager(gridLayoutManager);
            galleryAdapter = new GalleryAdapter(activity, recyclerView, imagePath, galleries, "Photos");
          ...
          //  galleryAdapter.setOnLoadMoreListener(this::onLoadMore);
            galleryAdapter.setPassGalleryDatas(new GalleryAdapter.PassGalleryDatas() {
                ...
                public void passData(int position) {
                    ...
                    bundle.putParcelableArrayList(Constants.GalleryDatas, (ArrayList<? extends Parcelable>) galleries);
                    bundle.putSerializable("ImagePath", (Serializable) imagePath);
                    Intent galleryViewIntent = new Intent(activity, EventGalleryViewActivity.class);
                    galleryViewIntent.putExtras(bundle);
